...
\author{Markus Loecher\\ Berlin School of Economics and Law (BSEL)  \\  \it{markus.loecher@gmail.com}}
...
\begin{verbatim}
  MyMap <- GetMap(markers = '&markers=color:blue|label:S|40.702147,-74.015794&markers=color:green|
